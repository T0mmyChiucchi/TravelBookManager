        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    OptimizedRoute = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripLocations", x => new { x.LocationsId, x.TripId });
                    table.ForeignKey(
                        name: "FK_TripLocations_Locations_LocationsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SavedTripsId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTrips", x => new { x.SavedTripsId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserTrips_Trips_SavedTripsId",
                        column: x => x.SavedTripsId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
